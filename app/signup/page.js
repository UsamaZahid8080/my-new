...
function page() {
  return (
   ...
   <h4 className='text-2xl font-bold tracking-normal leading-tight whitespace-pre-line mt-[1%]'>Sign up to Hi Squares</h4>
   <p className='mt-3 text-xs font-semibold'>By Signing up to Hi Squares,I agree to the <Link href="" className='text-red-500'>Condition of use</Link> and <Link href="" className='text-red-500'>Privacy policy</Link></p>
   ...
   <div className="flex items-center justify-center mt-[-2%] mb-[-2%]">
    ...
    <form className="">
      ...
      >
        <span className='text-sm font-semibold tracking-wider'>Sign Up</span>
      </button>
    </form>
    <div className='mb-[-7%]'>
    ...
    <div>
        <h5><span className='font-bold'>Already have an account?</span> <Link href="/login" className='text-red-500 text-xl font-bold'>Log in</Link></h5>
    </div>
   </div>
