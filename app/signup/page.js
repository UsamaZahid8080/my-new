...
function page() {
  return (
   ...
   <p className='mt-3 text-xs font-semibold'>By Signing up to Hi Squares,I agree to the <Link className='text-red-500'>Condition of use</Link> and <Link className='text-red-500'>Privacy policy</Link></p>
